<template>
	<div>
		...
		<div class="drag" ref="dragDiv">
	 	...
	 	<div class="title_box"
	     v-loading="loading"
	     element-loading-text="签发证书中"
	     element-loading-spinner="el-icon-loading"
	     v-if="confirmSuccess">
			
	    </div>
	    <div>
			<span>页面将自动下载证书文件，如果未自动开始，请点击<a href="#" @click="downloadCert">链接</a>手动下载</span>
	    </div>
	</div>
...
<script>
    ...
    export default {
    	...
    	computed:{
		     certUrl(){
		       return this.$store.getters.certUrl;
		     },
    	...
    	methods: {
    		...
    		downloadCert(){
    			window.open("/utils/download?0="+this.certUrl);
    		},
